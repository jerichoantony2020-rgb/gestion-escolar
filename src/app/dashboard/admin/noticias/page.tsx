  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold" style={{ color: "var(--fg)" }}>Noticias</h1>
          <p className="text-sm mt-1" style={{ color: "var(--muted)" }}>Publicaciones visibles en la página pública del colegio</p>
        </div>
